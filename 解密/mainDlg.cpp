...
CString CMainDlg::GetKey(CString pcInfoCode)
{
	CString str = L"3214569872021041520024925592652165";
...
void CMainDlg::OnBnClickedButton1()
{
	...
	CString result = GetKey(registerCode);
	keyEdit.SetWindowText(result);
}
